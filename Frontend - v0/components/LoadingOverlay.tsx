...
import { Check, FileText, Link, Brain, Sparkles } from "lucide-react"
...
const stepIcons = [FileText, Link, Brain, Sparkles]

export function LoadingOverlay({ isVisible, currentStep, steps }: LoadingOverlayProps) {
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
